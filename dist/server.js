...
export function buildMcpServer(user) {
    ...
    const server = new McpServer({ name: "calendar-mcp", version: "1.0.0" }, { instructions: "Tools to manage Google Calendar: list events, create/update/delete events, respond to invites, check free/busy. " + accountsHint });
